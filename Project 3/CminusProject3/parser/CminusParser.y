...
%type <symIndex> Expr SimpleExpr AddExpr Test IfStatement TestAndThen WhileStatement WhileExpr WhileToken 
...
WhileToken	: WHILE
		{
			$$ = emitWhileLoopEnd(instList,symtab);
		}
		;
...
Variable        : IDENTIFIER
                ...
                | IDENTIFIER LBRACKET Expr RBRACKET    
		{
			...
			int symIndex = SymQueryIndex(symtab,$1);
			$$ = emitComputeVariableAddressFromArray(instList,symtab,symIndex, $3);
